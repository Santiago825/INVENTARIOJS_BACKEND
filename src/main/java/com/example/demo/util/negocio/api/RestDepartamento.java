...
public class RestDepartamento {
	@Autowired
	ServiciosDepartamento ServicioDepartamento;
	
	@RequestMapping(value = ConstantesSeguridadPathRest.PATH_CONSULTAR_DEPARTAMENTOS, method = RequestMethod.GET, headers = "Accept="
			+ MediaType.APPLICATION_JSON_UTF8_VALUE)
	public  ResponseEntity<ListaDTO> consultarDepartamento() {
		System.out.println("chupo");
		ListaDTO respuesta = null;
		try {
			 respuesta = ServicioDepartamento.cosnultarDepartamento();
